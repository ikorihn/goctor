...
## Phase 3.1: Setup
- [ ] T001 Initialize Go module in doctor-cmd root with go.mod
- [ ] T002 Create complete Go project directory structure per plan.md
- [ ] T003 [P] Create testdata/manifests/sample.yaml with example tool definitions
- [ ] T004 [P] Create testdata/fixtures/tool-outputs.txt with sample command outputs

## Phase 3.2: Tests First (TDD) ⚠️ MUST COMPLETE BEFORE 3.3
**CRITICAL: These tests MUST be written and MUST FAIL before ANY implementation**

### Contract Tests [P]
- [ ] T005 [P] Contract test for doctor command CLI interface in tests/contract/test_doctor_cmd.go
- [ ] T006 [P] Contract test for list command CLI interface in tests/contract/test_list_cmd.go
- [ ] T007 [P] Contract test for JSON output schema validation in tests/contract/test_json_output.go
- [ ] T008 [P] Contract test for manifest YAML schema validation in tests/contract/test_manifest_schema.go

### Core Type Tests [P]
- [ ] T009 [P] Unit tests for ToolDefinition struct and validation in internal/manifest/tool_test.go
- [ ] T010 [P] Unit tests for Manifest struct and validation in internal/manifest/manifest_test.go
- [ ] T011 [P] Unit tests for CheckResult and status transitions in internal/checker/result_test.go
- [ ] T012 [P] Unit tests for semver parsing and comparison in internal/semver/semver_test.go

### Integration Tests [P]
- [ ] T013 [P] Integration test for basic environment check scenario in tests/integration/test_basic_check.go
- [ ] T014 [P] Integration test for JSON output validation in tests/integration/test_json_output.go
- [ ] T015 [P] Integration test for custom manifest loading in tests/integration/test_custom_manifest.go
- [ ] T016 [P] Integration test for tool listing functionality in tests/integration/test_tool_listing.go

## Phase 3.3: Core Implementation (ONLY after tests are failing)

### Data Types and Validation [P]
- [ ] T017 [P] Implement ToolDefinition struct with validation in internal/manifest/tool.go
- [ ] T018 [P] Implement Manifest, ManifestMeta, ManifestDefaults structs in internal/manifest/manifest.go
- [ ] T019 [P] Implement CheckResult, CheckStatus, EnvironmentReport structs in internal/checker/result.go
- [ ] T020 [P] Implement PlatformInfo and CheckSummary structs in internal/platform/info.go
